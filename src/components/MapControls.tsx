...
export const MapControls = () => {
  ...
  // --- REPARO 1: A FUNÇÃO QUE FALTAVA (CRITICO) ---
  const handleDrawToggle = () => {
      if (drawMode === 'draw_polygon') {
          setDrawMode('simple_select');
      } else {
          setDrawMode('draw_polygon');
          if (is3D) setIs3D(false); // Desliga 3D para facilitar desenho
      }
  };

  // --- REPARO 2: LÓGICA DE ZOOM ---
  ...
  return (
    <div className="w-full h-full pointer-events-none flex flex-col justify-between">
        ...
        <div className="flex gap-2 w-full relative">
            ...
            <div className="flex-1 relative group">
                ...
                {showResults && searchResults.length > 0 && (
                    <div className="absolute top-full mt-2 w-full bg-[#0f111a] border border-gray-700 rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto custom-scrollbar z-50">
                        <ul>
      ...
      {/* --- REPARO 3: BOTÕES DE ZOOM (Na direita, centralizados) --- */}
